...
import-installed-essentials:
	cd data-ops && PYTHONPATH=src python3 -m veduta_data.cli import-installed-packs --library-root "$(LIBRARY_ROOT)" --artpaper-image-root "$(ARTPAPER_IMAGE_ROOT)" --quality 5k --collection essentials
